...
import company.vk.edu.distrib.compute.mediocritas.audit.PushkinaAuditServiceFactoryImpl;
...
public class AuditServiceFactoryArgumentsProvider implements ArgumentsProvider {
    private final Set<ImmutablePair<Class<? extends KVServiceFactory>, Class<? extends AuditServiceFactory>>>
            factories = Set.of(
            ImmutablePair.of(PushkinaKVServiceFactoryImpl.class, PushkinaAuditServiceFactoryImpl.class)
    );
